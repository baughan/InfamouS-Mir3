        ...
        private static void SendActivationEmail(AccountInfo account)
        {
            ...
            Task.Run(() =>
            {
                try
                {
                    ...
                    {
                        Subject = "InfamouS Mir 3 Account Activation",
                        IsBodyHtml = true,

                        Body = $"Dear {account.RealName}, <br><br>" +
                               $"Thank you for registering a InfamouS Mir 3 account, before you can log in to the game, you are required to activate your account.<br><br>" +
...
//                               $"If the above link does not work please use the following Activation Key when you next attempt to log in to your account<br>" +
                               $"Please use the following Activation Key when you next attempt to log in to your account<br>" +
                               $"If the above link does not work please use the following Activation Key when you next attempt to log in to your account<br>" +
                ...
                try
                {
                    ...
                    MailMessage message = new MailMessage(new MailAddress(Config.MailFrom, Config.MailDisplayName), new MailAddress(account.EMailAddress))
                    {
                        ...
                        Body = $"Dear {account.RealName}\n" +
                               $"\n" +
                               $"Thank you for registering a InfamouS Mir 3 account, before you can log in to the game, you are required to activate your account.\n" +
                               $"\n" +
        ...
        private static void SendChangePasswordEmail(AccountInfo account, string ipAddress)
        {
            ...
            Task.Run(() =>
            {
                try
                {
                    ...
                    MailMessage message = new MailMessage(new MailAddress(Config.MailFrom, Config.MailDisplayName), new MailAddress(account.EMailAddress))
                    {
                        Subject = "InfamouS Mir 3 Password Changed",
                        IsBodyHtml = true,

                        Body = $"Dear {account.RealName}, <br><br>" +
                               $"This is an E-Mail to inform you that your password for InfamouS Mir 3 has been changed.<br>" +
        ...
        private static void SendResetPasswordRequestEmail(AccountInfo account, string ipAddress)
        {
            ...
            Task.Run(() =>
            {
                try
                {
                    ...
                    MailMessage message = new MailMessage(new MailAddress(Config.MailFrom, Config.MailDisplayName), new MailAddress(account.EMailAddress))
                    {
                        Subject = "InfamouS Mir 3 Password Reset",
                        IsBodyHtml = true,
...
//                               $"If the above link does not work please use the following Reset Key to reset your password<br>" +
                               $"Please use the following Reset Key to reset your password<br>" +
        ...
        private static void SendResetPasswordEmail(AccountInfo account, string password)
        {
            ...
            Task.Run(() =>
            {
                try
                {
                    ...
                    MailMessage message = new MailMessage(new MailAddress(Config.MailFrom, Config.MailDisplayName), new MailAddress(account.EMailAddress))
                    {
                        Subject = "InfamouS Mir 3 Password has been Reset.",
                        IsBodyHtml = true,

                        Body = $"Dear {account.RealName}, <br><br>" +
                               $"This is an E-Mail to inform you that your password for InfamouS Mir 3 has been reset.<br>" +
